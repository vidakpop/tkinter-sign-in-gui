...
def signin():
    ...
    if username in r.keys() and password==r[username]:
        ...
        Label(screen,text="WHY ARE YOU GAY\n\t🖕",bg='purple',font=('Calibri(Body)',50,'bold')).pack(expand=True)
...
heading=Label(frame,text='Sign In',fg='light blue',bg='white',font=('Microsoft Yahei UI Light',23,'bold'))
heading.place(x=100,y=5)
